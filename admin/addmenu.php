...
if(isset($_POST['add_main_menu']))
{
 ...
 $sql=$dbcon->query("INSERT INTO mainadmin_menu(m_menu_name,m_menu_link) VALUES('$menu_name','$menu_link')");
}
if(isset($_POST['add_sub_menu']))
{
 ...
 $sql=$dbcon->query("INSERT INTO subadmin_menu(m_menu_id,s_menu_name,s_menu_link) VALUES('$parent','$proname','$menu_link')");
}
?>
...
<?php
$res=$dbcon->query("SELECT * FROM mainadmin_menu");
